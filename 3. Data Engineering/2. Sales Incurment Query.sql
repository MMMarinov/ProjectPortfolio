...
(
    SELECT  ISNULL(GTH.REF_NUM,GT.REF_NUM) REF_NUM,
            ...
            ISNULL(ISNULL(RECENT_TREATY.CONTRACT_NUM,GTH.CONTRACT_NUM),GT.CONTRACT_NUM) CONTRACT_NUM,
    ...
    ON Recent_Treaty.REF_NUM = ISNULL(GTH.REF_NUM, GT.REF_NUM)
...
(
    SELECT  ISNULL(CT.REF_NUM,CTH.REF_NUM) REF_NUM,
            ...
            PARENT_COMP_NAME ISNULL(CT.STATUS,CTH.STATUS) STATUS,
